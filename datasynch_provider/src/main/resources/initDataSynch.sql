...
CREATE TABLE "ZHFT123"."DS_SCHEDULE_JOB_INFO" (
  ...
  "DB_SRC_CONN_PARAM" VARCHAR2(1024 BYTE) NULL ,
  "HTTP_PARAM_EXPRESSION" VARCHAR2(255 BYTE) NULL ,
...
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."DB_SRC_CONN_PARAM" IS '数据源连接参数IP;USRNAME;PASSWORD;DBURL';
