...
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."TB_NAME" IS '入库表名';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."SCHEDULE_EXPRESSION" IS '定时表达式';
...
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."TOKEN" IS '认证令牌';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."JSON_EXTRACT_RULE" IS 'JSON解析规则';
...
COMMENT ON COLUMN "ZHFT123"."DS_SYNCH_JOB_LOG_INFO"."CURRENT_PAGE" IS '当前请求页码';
COMMENT ON COLUMN "ZHFT123"."DS_SYNCH_JOB_LOG_INFO"."CURRENT_ROWNUM" IS '当前页最后一条数据的分页查询伪ID';
COMMENT ON COLUMN "ZHFT123"."DS_SYNCH_JOB_LOG_INFO"."UPDATE_WAY" IS '更新方式（0：数据库 1：接口）';
...
COMMENT ON COLUMN "ZHFT123"."DS_SYNCH_JOB_LOG_INFO"."PAGE_SIZE" IS '分页大小';
-- ----------------------------
