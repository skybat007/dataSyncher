...
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."IS_PAGING_QUERY" IS '是否分页(0:不分页；1:分页)';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."ORDER_BY_COL_NAME" IS '源-排序字段名称';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_PARAM_EXPRESSION" IS '入参表达式';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_TOKEN" IS 'token表达式';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_PAGING_TYPE" IS '分页参数组织形式（1:normal;2:json;3:position）';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_PARAM_PAGESIZE" IS 'pageSize映射名称';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_PARAM_PAGENUM" IS 'pageNum映射名称';
COMMENT ON COLUMN "ZHFT123"."DS_SCHEDULE_JOB_INFO"."HTTP_JSON_EXTRACTRULE" IS 'json结果集提取规则';
