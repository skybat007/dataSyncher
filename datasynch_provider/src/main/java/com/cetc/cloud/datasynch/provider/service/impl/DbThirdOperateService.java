 ...
 **/
@Service("dbThirdOperateService")
@Slf4j
@DS("third")
public class DbThirdOperateService {
    @Autowired
     ...
     * @throws SQLException
     */
    public List<String> oracleQueryList_1member(String sql) throws SQLException {
...
//    @DS("slave2")
    public boolean checkIfTableExists(String tbName) {
        ...
        try {
            ...
            log.error("Error :DbOperateService.checkIfTableExists(),SQL:" + sql);
            e.printStackTrace();
            return false;
        }
        return false;
    ...
    public void deleteRedundantTableCopies(String tableName) throws SQLException {
        ...
        List<String> list = oracleQueryList_1member(SQL);
        log.info(SQL);
