 ...
 **/
public abstract class AlarmTriggerAbstract extends BaseAlarmTrigger {
     ...
     * @return
     */
    protected abstract AlarmInformation row2Alarm(HashMap row);
     ...
     * @return
     */
    protected abstract boolean compareAlarm(AlarmInformation m1, AlarmInformation m2);
    ...
    public void triggerAlarm(){
        ...
        for (int i = 0; i < query.size(); ++i){    //遍历所有数据源
            ...
            AlarmInformation source = row2Alarm(row);  //将告警信息转换为预警模型
            if (source == null) continue;
            AlarmInformation last = queryLastAlarmData(source.getFRowId());    //获取该主体最新一条预警
