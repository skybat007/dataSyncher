...
public class ScheduleControllerTest extends TestCase {
    ...
    @Test
    public void testStartScheduleJobByJobId() throws Exception {
        String TABLE_NAME = "WEEKLY_WEIWEN";
        HashMap<String, String> map = scheduleController.triggerOnceJobByTargetTableName(TABLE_NAME);
        while (true);
    }
}