...
public class DbOperateService implements com.cetc.datasynch.service.DbOperateService {


    @Autowired
    DataSource dataSource;
    @Autowired
    com.cetc.datasynch.service.ColumnMappingService columnMappingService;
