...
public class MoblieMessageUtil {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(MoblieMessageUtil.class);
    ...
    static final String accessKeyId = "LTAInKXJZ1rRmg7V";
    static final String accessKeySecret = "if37JNDMqlr4qqKIdCd6W1VxKhsUPV";
    ...
    public static SendSmsResponse sendSms(String phone,String content) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("中电科智慧院");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_25160271");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{\"customer\":\""+content+"\"}");
    ...
    public static void sendMessage(String phone, String content) throws ClientException, InterruptedException {

        //发短信
        SendSmsResponse response = sendSms(phone,content);
